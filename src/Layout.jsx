...
export default function Layout({ children, currentPageName }) {
  ...
  return <div className="app-shell dm-app-shell">
    ...
    {isDosudebkaArea && !alreadyHasMarketFrame && <nav className="dm-service-nav" aria-label="Раздел Досудебка">
      <div className="dm-service-nav-inner">
        <Link className="dm-service-home" to="/dosudebka"><i className="fa-solid fa-scale-balanced" /><span><strong>Досудебка</strong><small>сервис ДокМаркет</small></span></Link>
        <div className="dm-service-links">
          ...
          <Link to="/market/cart">Корзина</Link>
