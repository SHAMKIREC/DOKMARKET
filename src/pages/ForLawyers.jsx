...
const flow = [
  ...
  ["4", "Завершайте работу", "После подключения оплаты выплата селлеру будет проходить после подтверждения выполнения заказа покупателем."],
];
...
export default function ForLawyers() {
  return <main className="dm-seller-page">
    ...
    <section className="dm-seller-flow">
      <div className="dm-seller-flow-head"><span>КАК ЭТО РАБОТАЕТ</span><h2>Один селлер — одна витрина — все заказы внутри приложения</h2><p>Покупатель видит рейтинг и отзывы, выбирает документ или услугу и не уходит в сторонние чаты для оформления заказа.</p></div>
