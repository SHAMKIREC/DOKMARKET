...
export default function SpecialistMaterialNew() {
  ...
  function choose(nextMode){if(nextMode==="online_form")return navigate("/template-studio/new");if(nextMode==="service")return navigate("/specialist/services/new");setMode(nextMode);setNotice(nextMode==="ready_file"?"":"Этот тип материала подключим следующим этапом. Сейчас полностью работает загрузка готового файла.");}
