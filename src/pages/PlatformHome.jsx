...
const ecosystem = [
  {to:"/dosudebka",type:"doc",eyebrow:"Сервис ДокМаркета",title:"Досудебка",text:"Создание досудебной претензии по ситуации с единым аккаунтом ДокМаркета.",action:"Создать претензию",accent:"orange"},
  {to:"/construction-docs",type:"build",eyebrow:"Сервис с партнёром Решаем Быстро",title:"Строительная документация",text:"ППР, акты, ведомости, журналы и автоматизация подготовки исходных данных.",action:"Открыть сервис",accent:"orange"},
  {to:"/seller",type:"seller",eyebrow:"Маркетплейс",title:"Стать селлером",text:"Своя витрина документов и услуг, рейтинг, отзывы и заказы внутри приложения.",action:"Открыть для продавцов"},
  {to:"/partners",type:"partners",eyebrow:"Экосистема",title:"Партнёры ДокМаркета",text:"Решаем Быстро и NRV DIGITAL: строительство, разработка и автоматизация.",action:"Смотреть партнёров"},
];

export default function PlatformHome(){
  return <div className="dm-platform-home">
    <style>{`
      .dm-market-quick a:nth-child(3) strong{font-size:0}.dm-market-quick a:nth-child(3) strong:after{content:'Селлер';font-size:.78rem}.dm-market-quick a:nth-child(3) small{font-size:0}.dm-market-quick a:nth-child(3) small:after{content:'Кабинет продавца';font-size:.62rem}
    ...
    <section className="dm-ecosystem-wrap" aria-label="Сервисы и экосистема ДокМаркета">
      <div className="dm-ecosystem-head"><div><span>ВНУТРИ ДОКМАРКЕТА</span><h2>Сервисы, селлеры и партнёры</h2></div><p>Маркет документов остаётся главным. Дополнительные сервисы открываются как отдельные продукты внутри одного приложения.</p></div>
